function openModal() {
  ...
  function enableButton(letter, capital, number, length, match) {
    ...
    anchor.href = "../../../lab-4-html-css-Oleracea/Personal_Website/mypage.html";
    anchor.append(button)
    var condition = (capital.classList == "valid" && letter.classList == "valid" && number.classList == "valid" && length.classList =="valid" && match.classList == "valid"); // TODO: Replace false with the correct condition
    if (condition) {
